            ...
            {message.attachment_url ? (
              <div className="flex flex-col gap-2">
                {message.attachment_type?.startsWith('image/') ? (
                  ...
                  <a href={message.attachment_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-2 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 rounded-xl border border-black/10 dark:border-white/10 transition-colors group/file">
                    ...
                    <div className="overflow-hidden flex-1 min-w-[120px] max-w-[200px]">
                      <p className="text-sm font-medium truncate text-slate-800 dark:text-slate-200">{message.attachment_name || 'Tài liệu đính kèm'}</p>
                    ...
                    <div className="p-1.5 rounded-full text-slate-400 hover:text-blue-500 bg-white/50 dark:bg-black/20">
                      <Download size={16} />
                    </div>
                  </a>
                )}
